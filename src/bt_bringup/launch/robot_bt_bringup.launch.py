...
def generate_launch_description():
    ...
    # Launch Grounding DINO Object Detection Service
    grounding_dino_service = Node(
        ...
        parameters=[{
            'use_sim_time': use_sim_time,
            'use_mock': False,  # Use real Grounding DINO model
            'model_config': '/opt/GroundingDINO/groundingdino/config/GroundingDINO_SwinT_OGC.py',
            'model_weights': '/workspace/models/grounding_dino/groundingdino_swint_ogc.pth',
